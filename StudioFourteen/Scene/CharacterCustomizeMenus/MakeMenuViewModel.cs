...
public abstract class MakeMenuViewModel : CharacterCustomizeMenu
{
	public MakeMenuViewModel(CharaMakeType.CharaMakeMenu makeMenu, CustomizeIndex customizeIndex, ToggleModes toggleMode)
