...
public class MultiIconMenu : MakeMenuViewModel
{
	...
	private void OnFaceChanged(byte faceType)
	{
		...
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[0]), FacialFeatureIndex.First));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[1]), FacialFeatureIndex.Second));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[2]), FacialFeatureIndex.Third));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[3]), FacialFeatureIndex.Fourth));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[4]), FacialFeatureIndex.Fifth));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[5]), FacialFeatureIndex.Sixth));
		this.Options.Add(new(new TextureIconReference(faceOptions.Options[6]), FacialFeatureIndex.Seventh));
		this.Options.Add(new(new TextureIconReference(0), FacialFeatureIndex.LegacyTattoo));
	...
	public class Option(TextureIconReference image, FacialFeatureIndex index)
	{
		public TextureIconReference Image => image;
