...
public struct UiPassData
{
	public Vector2 ScreenSize;
	public Vector2 RenderScale;
}

public class UiPass() : InstanceRenderPassBase<UiPassData>
{
	private readonly List<WindowRenderer> sceneObjects = new();
	...
	public void Add(WindowRenderer obj)
	{
	...
	public void Remove(WindowRenderer obj)
	{
		lock (this.sceneObjects)
		{
