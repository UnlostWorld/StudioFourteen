...
public class InputService : IService
{
	...
	public InputService()
	{
		Studio.Json.AddConverter<BindConverter>();
		...
		Studio.Tick.Add(TickChannels.LateGame, this.OnLateGameTick);
	...
	public void Dispose()
	{
		...
		Studio.Tick.Remove(TickChannels.LateGame, this.OnLateGameTick);
	...
	public void AddDevice(InputDeviceBase device)
	{
		lock (this)
		{
			...
			foreach (InputAxis axis in device.Axes)
			{
				...
				{
					Studio.Log.Error($"Axis Id collision: {axis.Id}");
					continue;
				}
