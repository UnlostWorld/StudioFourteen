...
public class RedrawService : IService
{
	private readonly Dictionary<CharacterBase, Request> redraws = new();
	...
	public Request Redraw(CharacterBase objectTableIndex, bool animate = true)
	{
		lock (this.redraws)
		{
			Request request;
	...
	public async Task RedrawAsync(CharacterBase character, bool animate = true)
	{
	...
	public bool IsRedrawing(CharacterBase character)
	{
	...
	protected void OnTick()
	{
		lock (this.redraws)
		{
			foreach ((CharacterBase character, Request request) in this.redraws)
			{
	...
	public class Request(CharacterBase character)
	{
