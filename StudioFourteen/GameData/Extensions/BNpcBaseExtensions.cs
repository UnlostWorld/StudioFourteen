...
using StudioBNpcCustomize = StudioFourteen.GameData.Sheets.BNpcCustomize;
...
public static class BNpcBaseExtensions
{
	public static string GetAppearanceHash(this BNpcBase npc)
	{
		...
		StudioBNpcCustomize? customize = ServiceManager.Instance.GameData.GetRow<StudioBNpcCustomize>(npc.BNpcCustomize.RowId);
