...
{
	public static readonly DummyStain None = new DummyStain(0, string.Empty);

	public static uint StainToItemRow(uint stainRow)
	{
		switch (stainRow)
		{
			case 1: return 5729;
...
public class DummyStain : Stain
{
	public DummyStain(byte id, string name, Color? color = null)
	{
		this.Id = id;
		this.Name = name;
		this.Color = color;

		this.Item = new DummyItem(name);
	}
}