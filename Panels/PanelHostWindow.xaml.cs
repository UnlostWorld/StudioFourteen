...
public partial class PanelHostWindow : Window
{
	...
	{
		get => this.ContentPresenter.Content as PanelBase;
	...
	public virtual void Show(PanelHostWindow copy)
	{
		this.Show();
	}
	...
	protected virtual void UpdatePosition()
	{
		...
		Point? savedPosition = null; //// this.Panel.Settings.Position;
		Size? savedSize = null; //// this.Panel.Settings.Size;
	...
	{
		if (this.Services.Settings.Current == null)
			return;

		if (this.Services.Settings.Current.Opacity != 1.0)
		{
			this.WindowContentArea.Animate(Grid.OpacityProperty, this.Services.Settings.Current.Opacity, 250);
		}
	}
	...
	{
		PanelHostOverlayWindow wnd = new();
		wnd.Show(this);
		base.Close();
	}
