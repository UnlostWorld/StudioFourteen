...
public class PanelHostOverlayWindow : PanelHostWindow
{
	public override Rect ScreenRect
	{
		get
		{
			if (Plugin.XivProcess == null)
				return new Rect(0, 0, 0, 0);

			GetClientRect(Plugin.XivProcess.MainWindowHandle, out Win32Rect clientRect);
			GetWindowRect(Plugin.XivProcess.MainWindowHandle, out Win32Rect gameRect);
	...
	protected override void OnWindowLoaded()
	{
		...
		this.Log.Information("!! " + Plugin.XivProcess);

		if (Plugin.XivProcess == null)
			return;

		this.Log.Information("!! " + Plugin.XivProcess.MainWindowHandle);

		SetParent(this.windowInteropHelper.Handle, Plugin.XivProcess.MainWindowHandle);
